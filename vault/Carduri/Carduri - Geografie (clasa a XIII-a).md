...
Ce sunt fiordurile și unde apar?::Golfuri înguste și adânci, formate în văi glaciare invadate de mare; sunt tipice Norvegiei.

Ce moderează clima Europei Nordice?::Curentul cald al Golfstreamului.

Ce caracterizează modelul social nordic?::Impozitare ridicată, servicii publice extinse, indicatori sociali foarte buni.

Care sunt marile centre financiare ale Europei Vestice?::Londra, Paris și Amsterdam.

Care este cea mai mare economie a Europei?::Germania.

Ce culturi sunt specifice agriculturii mediteraneene?::Măslinul, vița-de-vie și citricele.

Ce resurse importante are Europa Estică?::Gaze, petrol, cărbune, minereuri și cernoziomuri fertile.

Ce probleme are Europa Sudică?::Șomaj ridicat în rândul tinerilor, secetă, incendii, presiunea migrației.

La intersecția căror unități geografice se află România?::Carpații, Dunărea și Marea Neagră.

Ce avantaje îi dă României poziția geografică?::Acces la mare, culoar de transport european, diversitate naturală.

Care este principalul dezavantaj comparativ al României în regiune?::Infrastructura de transport slab dezvoltată.

Ce ar transforma poziția geografică în avantaj economic?::Investițiile în infrastructură: porturi, coridoare, rețele de transport.

Ce cere o comparație geografică corectă?::Criterii explicite, aceleași pentru toate elementele comparate.

Care este partea cea mai valoroasă a unei comparații?::Explicația diferențelor prin factori concreți.

De ce nu se compară PIB-ul total al unor state de mărimi diferite?::Pentru că valorile absolute nu sunt comparabile; se folosește PIB-ul pe locuitor.

Ce greșeli apar frecvent în comparații?::Scări diferite, date din ani diferiți, confuzia dintre valori absolute și relative.

Ce formă de stat are Germania?::Stat federal.
...
Ce este Meseta?::Podișul întins care ocupă cea mai mare parte a Peninsulei Iberice.

Ce obiectiv fixează Pactul Ecologic European?::Neutralitatea climatică a Uniunii Europene până în 2050.

Ce pondere din teritoriul României este inclusă în Natura 2000?::Aproximativ 23%.

Care sunt cele trei dimensiuni ale dezvoltării durabile?::Economică, socială și de mediu.

Ce probleme de mediu are România?::Tăierile ilegale, gestionarea deșeurilor, poluarea urbană, infrastructura de apă incompletă.

Pe ce se bazează subiectul I la proba de geografie?::Pe harta Europei, cu elemente marcate prin litere și cifre.
...
Ce este o hartă mută?::O hartă fără denumiri, folosită pentru exersarea localizării.

Ce se cere la subiectul al III-lea?::Interpretarea unui grafic sau tabel și teme privind Uniunea Europeană.

Care sunt pașii interpretării unui grafic?::Titlu și unități, extreme, tendință generală, explicație prin factori.

Ce greșeală apare frecvent la citirea datelor?::Confundarea creșterii valorii absolute cu creșterea ponderii.

Ce se pierde dacă rezultatul unui calcul nu are unitate de măsură?::Puncte, chiar dacă valoarea este corectă.

Ce este o cartogramă?::O hartă pe care valorile unui indicator sunt reprezentate prin culori sau hașuri.

Care sunt cei trei piloni ai pregătirii la geografie?::Harta, noțiunile și metoda de lucru.

De ce se pierd cele mai multe puncte la geografie?::Din nerespectarea cerinței, nu din necunoaștere.
...
Înapoi la [[Geografie (clasa a XIII-a)|Geografie (clasa a XIII-a)]] · [[Test - Geografie (clasa a XIII-a)]]
