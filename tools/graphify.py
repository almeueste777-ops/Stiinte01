...
def nota_start(curriculum, module, statistici):
    ...
    corp = [
        ...
        "",
        "Notele din acest vault sunt **generate automat** din datele aplicației PWA "
        "(`data/curriculum.json` și `data/continut.json`). Nu le edita direct: "
...
def main():
    ...
    # Curăț doar folderele generate; notele proprii ale utilizatorului rămân.
